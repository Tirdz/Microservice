using Microservice.Business.Features.Commands.Create;
using Microservice.Business.Features.Commands.Update;
using Microservice.Business.Features.Queries.Get;
using Microsoft.AspNetCore.Mvc;

namespace Microservice.API.Controllers.v1
{
    [ApiVersion("1.0")]
